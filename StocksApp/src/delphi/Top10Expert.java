...
public class Top10Expert {
	...
	private static String getBottom10Listing() {
		...
		try {
			URL url = new URL(
					"http://investing.money.msn.com/investments/stockscouter-top-rated-stocks?sco=1&col=20");
	...
	private static String getTop10Listing() {
		...
		try {
			URL url = new URL(
					"http://investing.money.msn.com/investments/stockscouter-top-rated-stocks?sco=10&col=20&asc=1");
	...
	public static String[] getTop10() {
		String[] top10List = { "TCCO", "SYMX", "CVM", "THLD", "TRNS", "CTRM",
				"BLIN", "ADNC", "RMKR", "ENMD" };
		return top10List;
	}

	public static String[] getBottom10() {
		String[] bottom10List = { "JRCC", "IDN", "KWK", "URRE", "AFFY", "FBN",
				"NBG", "AUMN", "JAG", "PRIS" };
		return bottom10List;
	}
}